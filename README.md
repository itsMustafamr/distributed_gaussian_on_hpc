...
This project investigates distributed training strategies for 3D Gaussian Splatting (3DGS) using PyTorch Distributed Data Parallel computing on Iowa State's Nova HPC cluster. 
And on multiple iterative experimentation i was able to get proper rendering of the gaussians.

I have run on Nova and used the resourses provided by Dr ali and TA shahrzad.

## DEMO Video

This is generated by Splatfacto which is run on NerfStudio and the video shows the gaussian redering result produced by using HPC and Distributed data parallel computing.
